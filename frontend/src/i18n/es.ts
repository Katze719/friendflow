...
const es: Translations = {
  ...
  "offline": {
    ...
    "onlineWaiting": "En línea · {{count}} cambios pendientes",
    "syncing": "Sincronizando",
    "synced": "Todo sincronizado",
    "internetRequired": "Se necesita conexión a Internet para esta acción.",
    "pending": "Aún no sincronizado",
    "syncingItem": "Sincronizando",
    "localDraft": "Guardado solo en este dispositivo",
  ...
  "theme": {
    ...
    "focusedMode": {
      ...
      "subtitle": "Oculta los títulos y las descripciones introductorias para ofrecer una vista más compacta."
    }
  },
  "layout": {
  ...
  "group": {
    ...
    "people": {
      ...
      "description": "Personas sin cuenta de Friendflow que participan plenamente en el libro.",
      "guest": "invitado",
      "add": "Añadir persona externa",
      "addShort": "Añadir",
      "name": "Nombre",
      "placeholder": "p. ej. Alex",
      "empty": "Todavía no hay personas externas.",
      "archived": "archivada",
      "archive": "Archivar",
      "restore": "Restaurar",
      "link": "Vincular",
      "linkSelect": "Vincular con un miembro …",
      "linkTitle": "¿Vincular persona?",
      "linkConfirm": "¿Vincular a {{guest}} con {{member}}? Sus movimientos y saldos se fusionarán.",
      "linked": "La persona se vinculó con el miembro."
    },
