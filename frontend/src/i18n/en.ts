const en = {
  ...
  group: {
    ...
    people: {
      ...
      description: "People without a Friendflow account who participate fully in the ledger.",
      guest: "guest",
      add: "Add external person",
      addShort: "Add",
      name: "Name",
      placeholder: "e.g. Alex",
      empty: "No external people yet.",
      archived: "archived",
      archive: "Archive",
      restore: "Restore",
      link: "Link",
      linkSelect: "Link to a member …",
      linkTitle: "Link person?",
      linkConfirm: "Link {{guest}} to {{member}}? Their bookings and balances will be merged.",
      linked: "The person was linked to the member.",
    },
    joined: "joined {{date}}",
  ...
  tools: {
    ...
    games: {
      name: "Games",
      description:
        "Spin a wheel to pick someone at random, or plan a points or knockout tournament with optional teams.",
    },
  },
  splitwise: {
    overview: {
  ...
  trips: {
    ...
    info: {
      ...
      nameTitle: "Trip",
      rename: "Rename",
      renameHint: "Press Enter to save the new name.",
  ...
  calendar: {
    overview: {
      ...
      personalTitle: "My calendar",
      personalSubtitle: "Private events, only visible to you.",
      togglePersonal: "My private events",
      toggleGroupEvents: "Events from my groups",
      timeFormatLabel: "Time format",
      timeFormat24: "24h",
      timeFormat12: "12h",
      personalBadge: "Private",
      fromGroup: "From: {{name}}",
      openInGroup: "Open in group calendar",
    },
    categories: {
      title: "Category",
      ...
      deleteConfirm: 'Remove category "{{name}}"? Events keep their data but lose their label.',
    },
    grid: {
  ...
  games: {
    title: "Games",
    subtitle: "Spin the wheel or run a tournament",
    backToGroup: "Back to group",
    tabs: {
      wheel: "Wheel",
    ...
    wheel: {
      ...
      winner: "Winner: {{name}}",
      empty: "Add at least two people to spin.",
      reset: "Clear all",
      removeWinner: "Remove winner",
      autoRemove: "Remove winner before next spin",
    },
    picker: {
      guestPlaceholder: "Guest name",
      addGuest: "Add",
      addAllMembers: "Add all members",
      allAdded: "All members added",
    },
    participants: {
      title: "Participants",
    ...
    tournaments: {
      ...
      emptyHint: "Create one to start planning matches.",
      create: "Create",
      nameLabel: "Name",
      namePlaceholder: "e.g. FIFA night",
      formatLabel: "Format",
      formatPoints: "Points",
      formatPointsHint: "Everyone plays everyone, ranked in a table.",
      formatElimination: "Knockout",
      formatEliminationHint: "Single elimination - lose and you're out.",
      teamsLabel: "Form teams",
      teamSizeLabel: "People per team",
      teamSizeHint:
        "The number of teams is worked out from this; leftovers are spread so some teams are one bigger. You can adjust teams by hand afterwards.",
      teamsLaterHint:
        "You'll decide on teams in the next step while adding people.",
    ...
    detail: {
      ...
      starting: "Starting...",
      needTwo: "Add at least two entrants to start.",
      entrantsReady_one: "{{count}} entrant ready",
      entrantsReady_other: "{{count}} entrants ready",
      teamModeOn: "Teams",
    ...
    teams: {
      title: "Teams",
      modeHint:
        "Off: everyone plays on their own. On: put people into teams that play each other.",
      randomize: "Randomize",
      randomizing: "Randomizing...",
      addTeam: "Add team",
      removeTeam: "Remove team",
      bench: "Not assigned",
      benchEmpty: "Everyone is on a team.",
      empty: "No teams yet. Randomize or add one.",
      moveHint: "Tap a person, then a team to move them.",
      moveSelectedHint: 'Moving "{{name}}" - tap a team or the bench.',
      moveHere: "Move here",
