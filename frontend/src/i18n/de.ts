...
const de: Translations = {
  ...
  group: {
    ...
    people: {
      ...
      description: "Personen ohne Friendflow-Konto, die im Kassenbuch vollständig mitgerechnet werden.",
      guest: "Gast",
      add: "Externe Person hinzufügen",
      addShort: "Hinzufügen",
      name: "Name",
      placeholder: "z. B. Alex",
      empty: "Noch keine externen Personen.",
      archived: "archiviert",
      archive: "Archivieren",
      restore: "Wiederherstellen",
      link: "Verknüpfen",
      linkSelect: "Mit einem Mitglied verknüpfen …",
      linkTitle: "Person verknüpfen?",
      linkConfirm: "{{guest}} mit {{member}} verknüpfen? Alle Buchungen und Salden werden zusammengeführt.",
      linked: "Person wurde mit dem Mitglied verknüpft.",
    },
  ...
  tools: {
    ...
    games: {
      name: "Spiele",
      description:
        "Per Glücksrad zufällig jemanden auslosen oder ein Punkte- bzw. Ausscheidungsturnier mit optionalen Teams planen.",
    },
  },
  splitwise: {
    overview: {
  ...
  games: {
    title: "Spiele",
    subtitle: "Glücksrad drehen oder ein Turnier veranstalten",
    ...
    wheel: {
      ...
      empty: "Füge mindestens zwei Personen hinzu, um zu drehen.",
      reset: "Alle entfernen",
      removeWinner: "Gewinner entfernen",
      autoRemove: "Gewinner vor dem nächsten Dreh entfernen",
    },
    picker: {
      guestPlaceholder: "Gastname",
      addGuest: "Hinzufügen",
      addAllMembers: "Alle Mitglieder hinzufügen",
      allAdded: "Alle Mitglieder hinzugefügt",
    },
    participants: {
      title: "Teilnehmer",
    ...
    tournaments: {
      ...
      emptyTitle: "Noch keine Turniere",
      emptyHint: "Lege eins an, um Spiele zu planen.",
      create: "Anlegen",
      nameLabel: "Name",
      namePlaceholder: "z. B. FIFA-Abend",
      formatLabel: "Format",
      formatPoints: "Punkte",
      formatPointsHint: "Jeder gegen jeden, Platzierung per Tabelle.",
      formatElimination: "K.-o.",
      formatEliminationHint: "Einfaches K.-o. - wer verliert, ist raus.",
      teamsLabel: "Teams bilden",
      teamSizeLabel: "Personen pro Team",
      teamSizeHint:
        "Die Anzahl der Teams ergibt sich daraus; Reste werden verteilt, sodass einzelne Teams einen mehr haben. Du kannst die Teams danach manuell anpassen.",
      teamsLaterHint:
        "Ob Teams gebildet werden, entscheidest du im nächsten Schritt beim Hinzufügen der Leute.",
    ...
    detail: {
      backToGames: "Zurück zu Spiele",
      startTournament: "Turnier starten",
      starting: "Startet...",
      needTwo: "Mindestens zwei Teilnehmer zum Starten.",
      entrantsReady_one: "{{count}} Teilnehmer bereit",
      entrantsReady_other: "{{count}} Teilnehmer bereit",
      teamModeOn: "Teams",
    ...
    teams: {
      title: "Teams",
      modeHint:
        "Aus: jede Person spielt für sich. An: Personen in Teams einteilen, die gegeneinander antreten.",
      randomize: "Zufällig zuweisen",
      randomizing: "Wird zugewiesen...",
      addTeam: "Team hinzufügen",
      removeTeam: "Team entfernen",
      bench: "Nicht zugewiesen",
      benchEmpty: "Alle sind in einem Team.",
      empty: "Noch keine Teams. Zufällig zuweisen oder eins hinzufügen.",
      moveHint: "Person antippen, dann ein Team zum Verschieben.",
      moveSelectedHint: '"{{name}}" verschieben - tippe ein Team oder die Bank an.',
      moveHere: "Hierher verschieben",
      moveToBench: "Auf die Bank",
      playerCount_one: "{{count}} Spieler",
      playerCount_other: "{{count}} Spieler",
      teamEmpty: "Leer",
    },
    standings: {
      title: "Tabelle",
    ...
    matches: {
      ...
      winHint: "Tippe auf den Sieger",
      draw: "Als Unentschieden markieren",
      drawShort: "Unent.",
    },
    bracket: {
      final: "Finale",
      champion: "Sieger: {{name}}",
    },
  },
  invite: {
